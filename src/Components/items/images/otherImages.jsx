        ...
        <main className={style.mainContainer}>
            <section>
                <div className={style.imagesDiv}>
                    ...
                    <img onClick={handleWashingMachine} src="https://www.reliancedigital.in/medias/Large-Appliances.jpg?context=bWFzdGVyfGltYWdlc3wzMzM1OXxpbWFnZS9qcGVnfGltYWdlcy9oZjIvaGQwLzEwMDc5NjE3MjUzNDA2LmpwZ3xhNjkwZTYzMTgwNjJmY2MxMjRiNjYwYjBlOWFkZGI2MDYzNGQyODEyMDUwNTFlMzliYjA3ZjEzMGMyZGEwMjNl" alt="image" />
                ...
                <div className={style.imagesDiv}>
                    ...
                    <img onClick={handleMobile} src="https://www.reliancedigital.in/medias/OnePlus-Nord-CE2-GDOE-Banners-Red-Grey-Banners-.jpg?context=bWFzdGVyfGltYWdlc3w0MzU4N3xpbWFnZS9qcGVnfGltYWdlcy9oODIvaDA2LzEwMDgyODMxMTcxNjE0LmpwZ3w2N2NlODI4YjExZTVhOGEyZDM2MWRhZjNiY2E3YWJlM2I4N2E2YzU0MGRlNjAxMzBlMTg3ZmVjYmY4NTU3OWMz" alt="image" />
                </div>
            </section>
        </main>
    )
