...
export const Laptop = ()=>{
    ...
    const fetchData = async () => {
        try {
          const response = await axios.get(`https://academics.newtonschool.co/api/v1/ecommerce/electronics/products?filter={"subCategory":"laptop"}&limit=100`, {
            headers: {
...
const displayedData = tvData.slice(startIndex, endIndex);
